            ...
            <div className="hidden lg:flex lg:flex-col lg:justify-center">
              <div className="mb-8">
                ...
                <p className="text-lg text-slate-600 dark:text-slate-400">
                  ...
                  to reset your password and get you back to bridging communication.
                </p>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-600 dark:text-slate-400">
                      Reset your password in just a few clicks and get back to providing quality
              ...
              <div className="mt-8 rounded-lg border border-blue-200 bg-blue-50 p-4 dark:border-blue-900 dark:bg-blue-950/50">
                <p className="text-sm text-blue-900 dark:text-blue-100">
                  ...
                  trouble resetting your password, please contact your system administrator or our
                  support team.
                </p>
              </div>
            </div>
